...
quizRouter.get('/quiz/:materialId/:pageNumber', async (req: Request<GetQuizParams>, res: Response) => {
    try {
...
quizRouter.post('/quiz/submit', async (req: Request, res: Response) => {
    try {
        const { material_id, page_number, user_id, selected_answer } = req.body as SubmitQuizBody;
...
quizRouter.get('/quiz/score/:userId/:materialId/:pageNumber', async (req: Request, res: Response) => {
    try {
