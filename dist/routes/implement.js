...
implementRouter.post('/workflows/:id/estimate', async (req, res) => {
    try {
        const { id } = req.params;
...
implementRouter.post('/estimate-nodes', async (req, res) => {
    try {
...
implementRouter.get('/auth/google/url', (req, res) => {
    try {
...
implementRouter.get('/auth/google/callback', async (req, res) => {
    try {
...
implementRouter.post('/workflows/:id/implement', async (req, res) => {
    try {
        const { id } = req.params;
        ...
        const calendarEvents = generateLearningSchedule(schedule.nodes, startDate, daily_hours || schedule.suggestedDailyHours);
